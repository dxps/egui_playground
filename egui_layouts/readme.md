...
3. Run `trunk serve` to build and serve on `http://127.0.0.1:8001`. Trunk will rebuild automatically if you edit the project.
4. Open `http://127.0.0.1:8001/index.html#dev` in a browser. See the warning below.
